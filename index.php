<?php
include("filmlane-master/header.php");
?>
              ...
              <div class="movie-card">
                ...
                <a href="movie-details.php?id=<?php echo $row['id'] ?>">
                  <figure class="card-banner">
                    <img src="Online-Movie-Booking-System/<?php echo $row['pictures']; ?>" alt="<?php echo $row['pictures']; ?>">
                  </figure>
                </a>
...
<?php
include("filmlane-master/footer.php");
?>